if get_values
    ...
    n_u_a_ref_dlyd = delayed.n_u_a_ref_dlyd;
    n_u_b_ref_dlyd = delayed.n_u_b_ref_dlyd;
    n_u_c_ref_dlyd = delayed.n_u_c_ref_dlyd;
    n_l_a_ref_dlyd = delayed.n_l_a_ref_dlyd;
    n_l_b_ref_dlyd = delayed.n_l_b_ref_dlyd;
    n_l_c_ref_dlyd = delayed.n_l_c_ref_dlyd;
end
...
if run_algebra
    ...
    if is_delayed
        n_u_a = n_u_a_ref_dlyd;
        n_u_b = n_u_b_ref_dlyd;
        n_u_c = n_u_c_ref_dlyd;
        n_l_a = n_l_a_ref_dlyd;
        n_l_b = n_l_b_ref_dlyd;
        n_l_c = n_l_c_ref_dlyd;
    else
        n_u_a = n_u_a_ref;
        n_u_b = n_u_b_ref;
        n_u_c = n_u_c_ref;

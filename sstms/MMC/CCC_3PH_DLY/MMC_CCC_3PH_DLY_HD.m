function HDi = MMC_CCC_3PH_DLY_HD(DSA, HDi)
    ...
    HDi.n_u_a_ref_dlyd(h2i(0))      = 0.5;
    HDi.n_u_b_ref_dlyd(h2i(0))      = 0.5;
    HDi.n_u_c_ref_dlyd(h2i(0))      = 0.5;
    HDi.n_l_a_ref_dlyd(h2i(0))      = 0.5;
    HDi.n_l_b_ref_dlyd(h2i(0))      = 0.5;
    HDi.n_l_c_ref_dlyd(h2i(0))      = 0.5;
    HDi.n_u_a_ref_dlyd(h2i([-1 1])) = DSA_sine(0.5,     -180);
    HDi.n_u_b_ref_dlyd(h2i([-1 1])) = DSA_sine(0.5, -120-180);
    HDi.n_u_c_ref_dlyd(h2i([-1 1])) = DSA_sine(0.5, -240-180);
    HDi.n_l_a_ref_dlyd(h2i([-1 1])) = DSA_sine(0.5,    0);
    HDi.n_l_b_ref_dlyd(h2i([-1 1])) = DSA_sine(0.5, -120);
    HDi.n_l_c_ref_dlyd(h2i([-1 1])) = DSA_sine(0.5, -240);
end
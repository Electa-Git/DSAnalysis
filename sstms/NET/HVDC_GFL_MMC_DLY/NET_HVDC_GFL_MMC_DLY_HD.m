function HDi = NET_HVDC_GFL_MMC_DLY_HD(DSA, HDi)
    ...
    HDi.v_g_1_a(h2i([-1 1]))         = DSA_sine(V_g_1_ph_pk, 0);
    HDi.v_g_1_b(h2i([-1 1]))         = DSA_sine(V_g_1_ph_pk, -120);
    HDi.v_g_1_c(h2i([-1 1]))         = DSA_sine(V_g_1_ph_pk, -240);
    ...
    HDi.v_d_1_ref(h2i(0))            = V_d_pk;
    HDi.q_g_1_ref(h2i(0))            = Q_g_1_ref;
    HDi.p_g_2_ref(h2i(0))            = P_g_2_ref;
    HDi.q_g_2_ref(h2i(0))            = Q_g_2_ref;
    ...
    HDi.i_s_1_al(h2i([-1 1]))          = DSA_sine(I_a_ph_pk, 0);
    HDi.i_s_1_be(h2i([-1 1]))          = DSA_sine(I_a_ph_pk, -90);
    HDi.i_c_1_a(h2i(0))                = I_d_pk/3;
    HDi.i_c_1_b(h2i(0))                = I_d_pk/3;
    HDi.i_c_1_c(h2i(0))                = I_d_pk/3;
    HDi.v_c_u_1_a(h2i(0))              = V_d_pk;
    HDi.v_c_u_1_b(h2i(0))              = V_d_pk;
    HDi.v_c_u_1_c(h2i(0))              = V_d_pk;
    HDi.v_c_l_1_a(h2i(0))              = V_d_pk;
    HDi.v_c_l_1_b(h2i(0))              = V_d_pk;
    HDi.v_c_l_1_c(h2i(0))              = V_d_pk;
    HDi.e_g_1_al_flt(h2i([-1 1]))      = DSA_sine(V_g_1_ph_pk, 90);
    HDi.e_g_1_be_flt(h2i([-1 1]))      = DSA_sine(V_g_1_ph_pk, 0);
    HDi.v_g_1_al_flt(h2i([-1 1]))      = DSA_sine(V_g_1_ph_pk, 0);
    HDi.v_g_1_be_flt(h2i([-1 1]))      = DSA_sine(V_g_1_ph_pk, -90);
    HDi.e_g_1_al_flt_quad(h2i([-1 1])) = DSA_sine(V_g_1_ph_pk, 0);
    HDi.e_g_1_be_flt_quad(h2i([-1 1])) = DSA_sine(V_g_1_ph_pk, -90);
    HDi.v_g_1_al_flt_quad(h2i([-1 1])) = DSA_sine(V_g_1_ph_pk, -90);
    HDi.v_g_1_be_flt_quad(h2i([-1 1])) = DSA_sine(V_g_1_ph_pk, -180);
    HDi.e_PLL_v_1(h2i(0))              = 0.01;
    HDi.theta_eps_v_1(h2i(0))          = 0.01;
    HDi.e_MV_1(h2i(0))                 = 0.01;
    HDi.e_MQ_1(h2i(0))                 = 0.01;
    HDi.e_MAC1_1_al(h2i([-1 1]))       = DSA_sine(0.01, 0);
    HDi.e_MAC1_1_be(h2i([-1 1]))       = DSA_sine(0.01, -90);
    HDi.e_MAC2_1_al(h2i([-1 1]))       = DSA_sine(0.01, 0);
    HDi.e_MAC2_1_be(h2i([-1 1]))       = DSA_sine(0.01, -90);
    HDi.e_MCC1_1_a(h2i(0))             = 0.01;
    HDi.e_MCC1_1_b(h2i(0))             = 0.01;
    HDi.e_MCC1_1_c(h2i(0))             = 0.01;
    HDi.e_MCC2_1_a(h2i(0))             = 0.01;
    HDi.e_MCC2_1_b(h2i(0))             = 0.01;
    HDi.e_MCC2_1_c(h2i(0))             = 0.01;
    
    HDi.i_s_2_al(h2i([-1 1]))          = DSA_sine(I_a_ph_pk, 0);
    HDi.i_s_2_be(h2i([-1 1]))          = DSA_sine(I_a_ph_pk, -90);
    HDi.i_c_2_a(h2i(0))                = I_d_pk/3;
    HDi.i_c_2_b(h2i(0))                = I_d_pk/3;
    HDi.i_c_2_c(h2i(0))                = I_d_pk/3;
    ...
    HDi.e_PLL_v_2(h2i(0))              = 0.01;
    HDi.theta_eps_v_2(h2i(0))          = 0.01;
    HDi.e_MP_2(h2i(0))                 = 0.01;
    HDi.e_MQ_2(h2i(0))                 = 0.01;
    ...
    HDi.v_d_u_1(h2i(0))                = V_d_pk/2;
    HDi.v_d_l_1(h2i(0))                = V_d_pk/2;
    HDi.i_z_u(h2i(0))                  = I_d_pk;
    HDi.i_z_l(h2i(0))                  = I_d_pk;
    HDi.v_d_u_2(h2i(0))                = V_d_pk/2;
    HDi.v_d_l_2(h2i(0))                = V_d_pk/2;
    
    % --- Delayed variables:
    % (just initial guesses)
    
    HDi.n_u_1_a_ref_dlyd(h2i(0))       = 0.5;
    HDi.n_u_1_b_ref_dlyd(h2i(0))       = 0.5;
    HDi.n_u_1_c_ref_dlyd(h2i(0))       = 0.5;
    HDi.n_l_1_a_ref_dlyd(h2i(0))       = 0.5;
    HDi.n_l_1_b_ref_dlyd(h2i(0))       = 0.5;
    HDi.n_l_1_c_ref_dlyd(h2i(0))       = 0.5;
    ...
    HDi.n_u_1_a_ref_dlyd(h2i([-1 1]))  = DSA_sine(0.5,     -180);
    HDi.n_u_1_b_ref_dlyd(h2i([-1 1]))  = DSA_sine(0.5, -120-180);
    HDi.n_u_1_c_ref_dlyd(h2i([-1 1]))  = DSA_sine(0.5, -240-180);
    HDi.n_l_1_a_ref_dlyd(h2i([-1 1]))  = DSA_sine(0.5,    0);
    HDi.n_l_1_b_ref_dlyd(h2i([-1 1]))  = DSA_sine(0.5, -120);
    HDi.n_l_1_c_ref_dlyd(h2i([-1 1]))  = DSA_sine(0.5, -240);
